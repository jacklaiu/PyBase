...
def notifyVolumeUnusual(security, volumeArrowCount=0):
    ...
    content = '<div style="padding: 10px">' \
        ...
        '</div>'
    sendEmail(subject='['+str(currentTimeString)+'] 成交量大增:'+str(volumeArrowCount)+'_' + security, content='' + content)
...
def notifyTrade(security, nowRate="?"):
    ...
    sendEmail(subject='['+str(currentTimeString)+'] 触发交易动作_' + security, content='rate: ' + nowRate + ' duo: ' + duo + ' kon: ' + kon + ' max: ' + max)
